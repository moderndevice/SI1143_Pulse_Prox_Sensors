...
void initPulseSensor(){
    ...
    // read the 
    pulse.setReg(PulsePlug::PS_LED21, 0x32);      // LED current for 2 (IR1 - high nibble) & LEDs 1 (red - low nibble) 
    ...
    pulse.writeParam(PulsePlug::PARAM_PSLED12_SELECT, 0x34);  // 21 select LEDs on for readings                                                               
    pulse.writeParam(PulsePlug::PARAM_PSLED3_SELECT, 0x02);   // 4 = LED 3 only
